# -*- coding: utf-8 -*-
"""
تحويل قاموس مصطلحات اللهجة العراقية (word.json) إلى صيغ تدريب جاهزة للـ Fine-Tuning.

المصدر:
- word.json : قاموس مصطلحات (930+ مصطلح، 50 فئة) — كلمة↔معنى وأسئلة حسب الفئة فقط،
              بدون أي محادثات.
...
def main():
    ...
    print(f"\nإجمالي أمثلة train_chat.jsonl: {len(glossary_examples)}")
    print(f"إجمالي أمثلة train_alpaca.jsonl: {len(glossary_examples)}")
